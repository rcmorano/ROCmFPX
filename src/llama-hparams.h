...
struct llama_hparams {
    ...
    std::array<uint32_t, LLAMA_MAX_LAYERS> n_ff_exp_arr; // per-layer expert ffn size
    std::array<uint32_t, LLAMA_MAX_LAYERS> n_expert_used_arr; // per-layer expert count
