...
struct llama_hparams {
    ...
    std::array<uint32_t, LLAMA_MAX_LAYERS> n_ff_exp_arr; // per-layer expert feed-forward size; scalar impl as broadcast fallback
    std::array<uint32_t, LLAMA_MAX_LAYERS> n_expert_used_arr; // per-layer top-k routing; scalar impl as broadcast fallback
    ...
    uint32_t n_ff_exp_impl    = 0; // per-layer expert feed-forward size; falls back to n_ff_exp_impl when array entry is 0
